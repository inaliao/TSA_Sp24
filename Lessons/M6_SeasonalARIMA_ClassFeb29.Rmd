...
# Find out how many time we need to difference by using ndiffs()
...
#the high coefficient in the PACF (spark at lag 1), meaning there might be the unit root in the series. 
#Thus, we will need to difference the series 
...
#we do not need to differencing the trend if we are feeding AR(2)
```
